 ...
 */
package de.marabs.analyse.common.component.type;
...
public enum ComponentType {
    ...
    JAVA_FIELD,
    /**
     * When we specialize a generic type (like e.g. in List<String>) we add the specialization as child to the component.
    ...
    /**
     * Each type specialization (e.g. String and Long from Map<String, Long>) gets an entry in the component representing
     ...
     * A parameterized type is a class or interface type of the form C<T1,...,Tn>, where C is the name of a generic
     * type and <T1,...,Tn> is a list of type arguments that denote a particular parameterization of the generic type.
     */
